...
domain_path    ：使用自定义域名访问时，显示网盘文件的路径，不设置时默认为根目录
                （格式为a.b.com=/dir/path1&b.b.com=/path2）
...
';
    ...
    if ($domain_path!='') {
        ...
        foreach ($tmp as $multidomain_paths){
            ...
            //$multidomain_path[substr($multidomain_paths,0,$pos)]=substr($multidomain_paths,$pos+1);
            if (substr($multidomain_paths,0,$pos)==$host_name) $private_path=substr($multidomain_paths,$pos+1);
        }
    }
...
<?php                   }
                    ...
                    <tr data-to id="tr<?php echo $filenum;?>">
                        ...
                        <td class="file">
                            ...
                            <a id="file_a<?php echo $filenum;?>" href="<?php echo path_format($config['base_path'] . '/' . $path . '/' . encode_str_replace($file['name'])); ?>?preview" target=_blank><?php echo str_replace('&','&amp;', $file['name']); ?></a>
